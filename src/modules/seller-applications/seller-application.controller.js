...
export const createSellerApplication =
    async (
        ...
        try {
            const data =
                createSellerApplicationSchema.parse(
                    req.body,
                );
...
export const getApplications =
    async (
        ...
        try {
            const query =
                sellerApplicationQuerySchema.parse(
                    req.query,
                );
...
export const reviewApplication =
    async (
        ...
        try {
            const { id } =
                sellerApplicationIdSchema.parse(
                    req.params,
                );

            const data =
                reviewSellerApplicationSchema.parse(
                    req.body,
                );
            ...
            return res
                ...
                .json({
                    success: true,
                    message:
                        "Seller application reviewed successfully",
                    data: application,
                });
        } catch (error) {
            next(error);
